...
{
    public class QueCorrectOptionMap : EntityTypeConfiguration<QueCorrectOption>
    {
        public QueCorrectOptionMap()
        {
            // Primary Key
            this.HasKey(t => t.Id);
            ...
            this.HasRequired(t => t.Book)
                .WithMany(t => t.QueCorrectOptions)
