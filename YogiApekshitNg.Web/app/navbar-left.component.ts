            ...
            <ul class="nav sidebar-nav">
                <li class="active open" style="background: #ec1b5a;">
                    <a href="#" class="dropdown-toggle">
                        ...
                        <div>
                            <button class="btn btn-info btn-xs" style="margin-left:25px;font-size:13px" (click)="this.sharedService.SetTestMode(!this.sharedService.IsAssessmentMode)">{{this.sharedService.SwitchModeText}}</button>
                        </div>                  
                    </a>
                </li>
