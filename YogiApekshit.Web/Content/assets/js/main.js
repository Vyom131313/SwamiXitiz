...
$(function () {
    ...
    MINOVATE.global = {
        ...
        layout: function () {
            ...
            //alert($.cookie("LeftMenuCollapseState"));
            MINOVATE.navbar.LeftMenuCollapse($.cookie("LeftMenuCollapseState"));
            MINOVATE.navbar.PersistActiveMenu();
        },
    ...
    MINOVATE.navbar = {
        ...
        LeftMenuCollapse: function (stats) {
            //alert(stats);
            var clsToSet = '';
            ...
            $app.addClass(clsToSet);

            $.cookie("LeftMenuCollapseState", clsToSet);
        ...
        collapse: function () {
            $collapseSidebarEl.on('click', function (e) {
                MINOVATE.navbar.LeftMenuCollapse();
                e.preventDefault();
            });
        },

        PersistActiveMenu: function () {
            var activeMenuHref = document.location.pathname;

            if (activeMenuHref != null && activeMenuHref != undefined) {

                var activeMenu = $("a[href='" + activeMenuHref + "']").first();
                if (activeMenu != null && activeMenu != undefined) {

                    $(activeMenu).parent().addClass('active');

                    var parentA = activeMenu.parent().parent().parent();
                    if (parentA != null && parentA != undefined) {

                        $(parentA).addClass('active open');
                    }
                }
            }
        },
